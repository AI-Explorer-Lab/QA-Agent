...
async def list_sessions(collection_name: str = "default", limit: int = 30):
    return await get_session_service().list_sessions(collection_name=collection_name, limit=limit)
